    ...
    <ReactLenis root>
      <main className="flex min-h-screen flex-col items-center">
        ...
        <section className="relative w-full h-screen overflow-hidden">
          ...
          <video
            ref={videoRef}
            src='https://res.cloudinary.com/drynqkitl/video/upload/v1747745531/saree_wuvfal.mp4'
            autoPlay
            muted
            loop
            playsInline
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Image
                  width={1000}
                  height={1000}
                  src="https://images.pexels.com/photos/2179204/pexels-photo-2179204.jpeg"
                  alt="Artisan at work"
                ...
                <Image
                  width={1000}
                  height={1000}
                  src="https://images.pexels.com/photos/2062055/pexels-photo-2062055.jpeg"
                ...
                <Image
                  width={1000}
                  height={1000}
                  src="https://images.pexels.com/photos/2710112/pexels-photo-2710112.jpeg"
                ...
                <Image
                  width={1000}
                  height={1000}
                  src="https://images.pexels.com/photos/5662349/pexels-photo-5662349.jpeg"
